  ...
  <div>
    ...
    <div class="gva-table-box">
      ...
      >
        ...
        <el-table-column align="left" sortable label="下单日期" width="180">
        ...
        <el-table-column
          ...
          width="120"
        />
        <el-table-column align="left" sortable label="加急" prop="urgent" width="120">
          <template #default="scope">
            <span v-if="scope.row.urgent">加急</span>
            <span v-else>非加急</span>
          </template>
        </el-table-column>
        <el-table-column
          align="left"
